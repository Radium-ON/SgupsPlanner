...
{
    public class EventEditViewModel : ValidatedViewModel<EventObservable>
    {
        public EventEditViewModel(EventObservable observable) : base(observable)
        {
        ...
        public int EventId => entity.EventId;
        ...
        public ObservableCollection<FileObservable> Files => entity.Files;
        #endregion
